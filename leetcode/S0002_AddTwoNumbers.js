...
4.2020-12-02更新：循环条件两个只要有一个不为空就行，我想复杂了，里面写成了都不为空，结果判断循环结束再加尾巴很麻烦
5.2021-1-8 回过头来看，张磊还是比我写的优雅一些；即使我用了三元判断符，但是重复了判断和l1,l2的往后走，可以一步到位的；
往后走的时候很容易忘了再次判断非空，又出错了*/
